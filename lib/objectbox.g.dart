...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 3207705774049610076),
      name: 'Todo',
      lastPropertyId: const IdUid(3, 8978446684998706832),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 959084643462299882),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 951379445494358449),
            name: 'desc',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 8978446684998706832),
            name: 'completed',
            type: 1,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 3207705774049610076),
...
class Todo_ {
  ...
  /// see [Todo.desc]
  static final desc = QueryStringProperty<Todo>(_entities[0].properties[1]);
